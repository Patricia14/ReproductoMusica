...
$obj = new management();
$dato=$obj->consulta("select * from privacidad where id_Privacidad='$fila'");
 ?>
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal" method="POST" action="../mantenimiento_privacidad/insercion_privacidad.php" id="formCliente">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input id="txtnombre" name="txtnombre" type="text" class="form-control"  value="<?php echo $valor["nombre_Privacidad"];?>">
                    </div>
                  </div>
