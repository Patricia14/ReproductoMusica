...
$obj = new management();
$dato=$obj->consulta("select * from artista where id_Artista='$fila'");
 ?>
    <div id="wrapper">
       ...
       <!-- End Navigation-->
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form class="form-horizontal" method="POST" action="../mantenimiento_Artista/insercion_Artista.php" id="formCliente">
                  
                  <div class="form-group">
                    <label for="nombre" class="control-label col-xs-5">Nombre de Artista:</label>
                    <div class="col-xs-5">
                        <input id="txtnombre" name="txtnombre" type="text" class="form-control" value="<?php echo $valor["nombre_Artista"];?>">
                    </div>
                 </div>

                    <div class="form-group">
                    <label for="nombre" class="control-label col-xs-5">Nacionalidad:</label>
                    <div class="col-xs-5">
                        <input id="txtnacionalidad" name="txtnacionalidad" type="text" class="form-control" value="<?php echo $valor["nacionalidad_Artista"];?>">
                    </div>
                  </div>
              ...
              <div class="modal-footer">  
                <a href="../navegacion_admin/adminArtista.php" class="btn btn-danger" role="button">Regresar</a>
