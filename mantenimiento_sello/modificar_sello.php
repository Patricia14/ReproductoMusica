...
$obj = new management();
$dato=$obj->consulta("select * from sello where id_Sello=$fila");
 ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- Page Heading -->
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          Datos de sello musical
                        </h1>
                          <?php foreach ($dato as $valor) {?>
                <form class="form-horizontal" method="POST" action="../mantenimiento_sello/insercion_sello.php" id="formCliente">
                  <div class="form-group">
                    <label for="nombre" class="control-label col-xs-5">Nombre:</label>
                    <div class="col-xs-5">
                        <input id="txtnombre" name="txtnombre" type="text" class="form-control" placeholder="Ingrese su Email" value="<?php echo $valor["nombre_Sello"];?>">
                    </div>
                  </div>
              ...
              <div class="modal-footer">  
                <a href="../navegacion_admin/adminSello.php" class="btn btn-danger" role="button">Regresar</a>
