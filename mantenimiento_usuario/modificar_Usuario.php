       ...
       <!-- End Navigation-->
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form class="form-horizontal" method="POST" action="../mantenimiento_Usuario/insercion_Usuario.php" id="formCliente">
              ...
              <div class="modal-footer">  
                <a href="../navegacion_admin/adminUsuario.php" class="btn btn-danger" role="button">Regresar</a>
