...
header( "refresh:5; ../navegacion_admin/adminGenero.php");
 ...
 ?>
                ...
                <form class="form-horizontal" method="POST" action="../mantenimiento_Genero/insercion_Genero.php" id="formCliente">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <textarea id="txtdescripcion" name="txtdescripcion" type="text" class="form-control" rows="10" cols="50" ></textarea>
                    </div>
                  </div>
