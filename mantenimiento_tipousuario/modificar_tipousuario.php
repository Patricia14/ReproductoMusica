...
$obj = new management();
$dato=$obj->consulta("select * from tipousuario where id_TipoUsuario=$fila");
 ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- Page Heading -->
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          Datos del nuevo privilegio
                        </h1>
                          <?php foreach ($dato as $valor) {?>
                <form class="form-horizontal" method="POST" action="../mantenimiento_tipousuario/insercion_tipousuario.php" id="formCliente">
                  <div class="form-group">
                    <label for="nombre" class="control-label col-xs-5">Nombre:</label>
                    <div class="col-xs-5">
                        <input id="txtnombre" name="txtnombre" type="text" class="form-control" placeholder="Ingrese su Email" value="<?php echo $valor["nombre_TipoUsuario"];?>">
                    </div>
                  </div>
              ...
              <div class="modal-footer">  
                <a href="../navegacion_admin/adminTipoUsuario.php" class="btn btn-danger" role="button">Regresar</a>
