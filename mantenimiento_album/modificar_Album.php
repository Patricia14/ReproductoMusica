...
$obj = new management();
$dato=$obj->consulta("select * from album inner join artista on album.id_Artista=artista.id_Artista where id_Album='$fila'");
$datosArtista=$obj->consulta("SELECT * FROM artista ");
 ?>
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal" method="POST" action="../mantenimiento_album/insercion_album.php" id="formCliente">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input id="txtnombre" name="txtnombre" type="text" class="form-control" value="<?php echo $valor["nombre_Album"];?>">
                    </div>
                 </div>
                    ...
                    <div class="col-xs-5">
                       ...
                       <option value="<?php echo $valor["id_Artista"];?>"><?php echo $valor["nombre_Artista"];?></option>
                         <?php foreach ($datosArtista as $fila1) {

                               echo "<option value='".$fila1["id_Artista"]."'>".$fila1["nombre_Artista"]."</option>"; 
