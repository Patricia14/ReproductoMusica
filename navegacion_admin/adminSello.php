...
<body>
    ...
    <div id="wrapper">
      ...
      $obj = new management();
      $datos=$obj->consulta("SELECT * FROM sello");
                ...
                <div class="row">
                  <div class="col-lg-12">
                        <h1 class="page-header">
                            Mantenimiento de Sello musical
                        </h1>
                              <?php 
if($_REQUEST){
...
header( "refresh:2; ../navegacion_admin/adminSello.php");

}
 ?>
                        <a href="../mantenimiento_sello/insert_sello.php" class="btn btn-primary btn-lg active" role="button">Nuevo Sello musical</a>
                        <br><br>
                         ...
                         <table class="table table-bordered">
                          ...
                          <tr>
                           ...
                           <td><?php echo $fila["id_Sello"]; ?></td>
                            <td><?php echo $fila["nombre_Sello"]; ?></td>
                            <td> 
                            <?php echo "<a href=\"../mantenimiento_sello/modificar_sello.php?fila=".$fila["id_Sello"]."\">" ?>
                                  <span class="glyphicon glyphicon-pencil"></span>
                                </a></td>
                                <td> 
                            <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_sello/insercion_sello.php?borrar=".$fila["id_Sello"]."&funcion=eliminar\">" ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_sello/insercion_sello.php?borrar=".$fila["id_Sello"]."&funcion=eliminar\">" ?>Eliminar</a>
