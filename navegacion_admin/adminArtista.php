...
header( "refresh:2; ../navegacion_admin/adminArtista.php");

}
 ?>
                        <a href="../mantenimiento_artista/insert_artista.php" class="btn btn-primary btn-lg active" role="button">Nuevo Artista</a>
                        <br><br>
                         
                         <table class="table table-bordered">
                          <tr>
                            <td>ID</td>
                            <td>Nombre Artisra</td>
                           
                            <td>Nacionalidad Artista</td>
                             <td>Modificar</td>
                            <td>Eliminar</td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><?php echo $fila["nacionalidad_Artista"]; ?></td>
                            <td> 
                            <?php echo "<a href=\"../mantenimiento_artista/modificar_artista.php?fila=".$fila["id_Artista"]."\">" ?>
                                  <span class="glyphicon glyphicon-pencil"></span>
                                </a></td>
                                <td> 
                            <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_artista/insercion_artista.php?borrar=".$fila["id_Artista"]."&funcion=eliminar\">" ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_artista/insercion_artista.php?borrar=".$fila["id_Artista"]."&funcion=eliminar\">" ?>Eliminar</a>
