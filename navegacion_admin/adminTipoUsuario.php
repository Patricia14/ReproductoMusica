...
<body>
    ...
    <div id="wrapper">
      ...
      $obj = new management();
      $datos=$obj->consulta("SELECT * FROM tipousuario");
                ...
                <div class="row">
                  <div class="col-lg-12">
                        <h1 class="page-header">
                            Mantenimiento de privilegio de usuario
                        </h1>
                              <?php 
if($_REQUEST){
...
header( "refresh:2; ../navegacion_admin/adminTipoUsuario.php");

}
 ?>
                        <a href="../mantenimiento_tipousuario/insert_tipousuario.php" class="btn btn-primary btn-lg active" role="button">Nuevo privilegio de usuario</a>
                        <br><br>
                         ...
                         <table class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <td> 
                            <?php echo "<a href=\"../mantenimiento_tipousuario/modificar_tipousuario.php?fila=".$fila["id_TipoUsuario"]."\">" ?>
                                  <span class="glyphicon glyphicon-pencil"></span>
                                </a></td>
                                <td> 
                            <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_tipousuario/insercion_tipousuario.php?borrar=".$fila["id_TipoUsuario"]."&funcion=eliminar\">" ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <?php echo "<a  class=\"btn btn-success\" href=\"../mantenimiento_tipousuario/insercion_tipousuario.php?borrar=".$fila["id_TipoUsuario"]."&funcion=eliminar\">" ?>Eliminar</a>
